...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $article['member_id']   = $_POST['member_id'] ?? 0;
    $article['category_id'] = $_POST['category_id'] ?? 0;
    ...
    <div class="admin-article">
      ...
      <section class="image">
        <?php if (!$article['image_file']) { ?>
          ...
          <div class="form-group">
            ...
            <input type="text" name="image_alt" id="image_alt"
                   value="<?= html_escape($article['image_alt']) ?>"
                   class="form-control">
        ...
        <?php } else { ?>
          ...
          <p class="alt">
            <strong>Alt text:</strong> <?= html_escape($article['image_alt']) ?>
          </p>
